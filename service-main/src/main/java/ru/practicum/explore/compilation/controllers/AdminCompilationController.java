...
public class AdminCompilationController {
    ...
    public CompilationDto addCompilation(@Valid @RequestBody CompilationNewDto compilationDto) {
        log.info(String.format("Получен POST- запрос: /admin/compilations (Admin). Добавлена подборка событий (dto) %s",
                compilationDto));
    ...
    public CompilationDto updateCompilation(@PathVariable Long compId,
        ...
        log.info(String.format("Получен PATCH- запрос: /admin/compilations{compId} (Admin). " +
                "Подборка событий (id)  обновлена (dto): %s, %s", compId, compilationDto));
    ...
    public void deleteCompilation(@PathVariable Long compId) {
        ...
        log.info(String.format("Получен DELETE- запрос: /admin/compilations{compId} (Admin). " +
                "Удалена подборка событий (id): %s", compId));
